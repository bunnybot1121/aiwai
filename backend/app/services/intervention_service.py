...
async def approve_intervention(
    ...
    """
    Approve an intervention in the Human Approval Gate desk.
    """
    ...
    intervention.execution_status = "executed"
    intervention.reviewer_notes = notes or f"Approved by {reviewer}"
...
async def record_intervention_outcome(
    ...
    # Compound memory into HistoricalOutcome store
